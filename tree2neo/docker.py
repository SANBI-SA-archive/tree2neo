...
class Docker(object):
    ...
    def __init__(self, outputdir, use_bolt=False,
        ...
        self.name = '_'.join(['vcf2neo', random.choice(self.__class__.WORDS),
                             random.choice(self.__class__.WORDS)])
    ...
    def run(self):
        ...
        if self.use_bolt:
            ...
            bolt_string = ''
        # ensure that Docker image is available before we try and run it
